...
public:
	EntitySpider() : IModule(0, Category::ENTITY, "Climb walls with mobs!") {
		registerFloatSetting("Speed", &speed, 0.6f, 0.1f, 3.f);
		registerBoolSetting("Avoid Overshooting", &dontOvershoot, true);
	}
	~EntitySpider(){};
	// Inherited via IModule
	virtual const char* getModuleName() override { return "EntitySpider"; }
	static std::vector<C_Entity*> targetNutz;
	static void findNutz(C_Entity* currentEntity, bool isRegularEntity) {
