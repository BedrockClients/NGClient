	...
	if (!(g_Data.getLocalPlayer() == nullptr || !GameData::canUseMoveKeys())) {
		...
		for (int j = 9; j < 18; j++) {
			if ((item->getItemStack(j)->item != nullptr)) {
				...
				if (item->getItemStack(j)->count > 1)
					DrawUtils::drawText(vec2_t(xVal + 6.5f, (yVal + 0.f) + 9.5f), &stackStr, MC_Color(InventoryView::rtext, InventoryView::gtext, InventoryView::btext), 1.f - .20f);
			}
			xVal += 17.f;
		}
		xVal -= 180.f;
		for (int j = 18; j < 27; j++) {
			if ((item->getItemStack(j)->item != nullptr)) {
				...
				std::string stackStr = std::to_string(item->getItemStack(j)->count);
				if (item->getItemStack(j)->count > 1)
					DrawUtils::drawText(vec2_t(xVal + 33.5f, (yVal + 20.f) + 9.5f), &stackStr, MC_Color(InventoryView::rtext, InventoryView::gtext, InventoryView::btext), 1.f - .20f);
			}
			xVal += 17.f;
		}
		xVal -= 180.f;
		for (int j = 27; j < 36; j++) {
			if ((item->getItemStack(j)->item != nullptr)) {
				...
				std::string stackStr = std::to_string(item->getItemStack(j)->count);
				if (item->getItemStack(j)->count > 1)
					DrawUtils::drawText(vec2_t(xVal + 60.5f, (yVal + 40.f) + 9.5f), &stackStr, MC_Color(InventoryView::rtext, InventoryView::gtext, InventoryView::btext), 1.f - .20f);
			}
			xVal += 17.f;
		}
		xVal -= 180.f;
		for (int j = 0; j < 9; j++) {
			if ((item->getItemStack(j)->item != nullptr)) {
				...
				std::string stackStr = std::to_string(item->getItemStack(j)->count);
				if (item->getItemStack(j)->count > 1)
					DrawUtils::drawText(vec2_t(xVal + 86.5f, (yVal + 60.f) + 9.5f), &stackStr, MC_Color(InventoryView::rtext, InventoryView::gtext, InventoryView::btext), 1.f - .20f);
			}
			xVal += 17.f;
		}
		xVal -= 180.f;
