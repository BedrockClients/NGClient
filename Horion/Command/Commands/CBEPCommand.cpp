...
CBEPCommand::CBEPCommand() : IMCCommand("cbep", "Gives you cbe presets", "<gmc/gms/gma> <write> <house> <kick/kill/tp> <day/night> <admin/disable> <nuke/realmkill/gravity/tntstorm>") {
	registerAlias("cp");
}
