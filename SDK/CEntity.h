...
public:
	...
	virtual void explode(C_BlockSource &, Actor *, vec3_t const &, float, bool, bool, float, bool);
	...
	virtual void spawnParticleEffect2(std::basic_string<char, std::char_traits<char>, std::allocator<char>> const &, Actor const &, vec3_t const &);
...
public:
	...
	virtual void addParticleEffect(HashedString const &, Actor const &, HashedString const &, vec3_t const &, MolangVariableMap const &);
