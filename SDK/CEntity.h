...
virtual __int64 getLastHurtByMob(void);                                                                                                                                                                                       // 0
	...
	virtual __int64 isInWater(void);                                                                                                                                                                                              // 71
	virtual __int64 hasEnteredWater(void);                                                                                                                                                                                        // 72
	virtual __int64 isInLava(void);                                                                                                                                                                                               // 73
	virtual __int64 isUnderLiquid(int materialType);                                                                                                                                                                                  // 74
	virtual __int64 isOverWater(void);                                                                                                                                                                                            // 75
...
public:
	...
	virtual __int64 canOpenContainerScreen(void);                                                                                                     // 385
