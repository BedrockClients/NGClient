...
void Hooks::Init() {
	...
	// Signatures
	{
		...
		//void* ConnectionRequest__create = reinterpret_cast<void*>(FindSignature("24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 4D 8B E1 49 8B F8 48 89 55"));
