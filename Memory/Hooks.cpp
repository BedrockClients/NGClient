...
void Hooks::Init() {
	...
	// Signatures
	{
		...
		void* autoComplete = reinterpret_cast<void*>(FindSignature("48 8B C4 55 57 41 56 48 8D 68 ? 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 58 ? 48 89 70 ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 ? 41 8B F9 4D 8B F0"));
		...
		void* ConnectionRequest__create = reinterpret_cast<void*>(FindSignature("40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ?? ?? ?? ?? 48 81 EC ?? ?? 00 00 48 8B ?? ?? ?? ?? ?? 48 33 C4 48 89 85 ?? ?? 00 00 49 8B D9 48 89 55 E8"));
